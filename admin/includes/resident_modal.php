    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><b>Approval for Resident</b></h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="residents_edit_approval.php">
                    <input type="hidden" name="id" id="edit_approval" value="">
                    <div class="form-group">
                        <div class="modal-body">
                            <label for="edit_approval">Approval</label>
